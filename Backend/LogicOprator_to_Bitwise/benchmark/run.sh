PATH2LIB=~/583teadem/HW2/F22_EECS583_HW2Template/build/HW2/LLVMHW2.so        # Specify your build directory in the project
PASS=-fplicm-correctness                   # Choose either -fplicm-correctness or -fplicm-performance
# 583teadem/HW2/F22_EECS583_HW2Template/build
